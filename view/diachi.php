...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../asset/slick-master/slick/slick.css" />
  <link rel="stylesheet" href="../src/assets/themify-icons/themify-icons.css">
        ...
        <div class="colums row-col-2">
          <div class="sidebar-main">
            ...
            <div class="nav_items">
              ...
              <hr>
              <ul><br>
                <li class="nav_item"><a href="thongtin-tkU.html">Thông tin tài khoản</a></li><br>
                <li class="nav_item"><a href="diachiU.html">Địa chỉ giao hàng</a></li><br>
                <li class="nav_item"><a href="">Lịch sử mua hàng</a></li><br>
                <li class="nav_item"><a href="sp-yeuthichU.html">Sản phẩm yêu thích</a></li><br>
                <br>
                <hr>
                <br>
          ...
          <div class="colums_main">
            <div class="page-title">
              ...
              <span>Quản lý thông tin địa chỉ giao hàng</span>
            </div>
            <hr>
            <div class="account-information">
              <table>
                <tbody>
                  <td><strong>cuong nguyen</strong></td>
                  <td>
                    <p>Đ. Hoàng Mai, Phường Phú Lãm, Quận Hà Đông, Thành phố Hà Nội 0966981411</p>
                  </td>
                  <td><span>Chỉnh sửa</span></td>
                  <td><i class="ti-close"></i></td>
                </tbody>
              </table>
              <span class="btn_capnhap">THÊM ĐỊA CHỈ MỚI</span>
            </div>
          </div>
...
<script type="text/javascript" src="../asset/slick-master/slick/slick.min.js"></script>
