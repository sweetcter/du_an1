                    ...
                    <div class="">
                      ...
                      <div class="col-lg-6">
                        <div class="checkout__input">
                          ...
                          <input type="text" id="username" value="<?php if(isset($username)) $username  ?>" disabled placeholder="username" required>
                        </div>
                      </div>
                      <div class="row-col-6">
                        ...
                        <div class="checkout__input">
                          ...
                          <input type="text" id="fullname" value="<?php if(isset($full_name)) $full_name  ?>" placeholder="Họ và tên" required>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="checkout__input">
                          <p>Email <span>*</span></p>
                          <input type="email" id="email" value="<?php if(isset($email)) $email ?>" placeholder="Your email" required>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="checkout__input">
                          <p>Số điện thoại <span>*</span></p>
                          <input type="tel" value="<?php if(isset($phone)) $phone ?>" id="Number" required>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="checkout__input">
                          <p>Địa chỉ <span>*</span></p>
                          <input type="text" value="<?php if(isset($address)) $address ?>" id="address" required>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="checkout__input">
                          <p>Password <span>*</span></p>
                          <input type="password" id="password" value="<?php if(isset($password)) $password ?>" placeholder="Enter a password" required>
                        </div>
                      </div>
                    </div>
                    <style>
