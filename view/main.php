...
<head>
  ...
  <script src="https://kit.fontawesome.com/5614ac6426.js" crossorigin="anonymous"></script>
...
<body>
  <div class="x font">
        ...
        <div class="header_row1 flexx" style="display: none">
          <div class="row1 flexx">
            <div class="row1_left flexx">
              <div class="logo">
                <img src="../<?= $ROOT_URL ?>/asset/images/logo.png" style="width: 118px; height: 33px" alt="logo tiki" />
              </div>
            </div>
          </div>
        ...
        <div class="header_row2">
          <div class="danhmuc">
            <ul class="flexx">
              ...
              <li><a href="<?= $ROOT_URL ?>/female-fashion">NỮ</a></li>
              <li><a href="#">NEW</a></li>
              <li><a href="#">BEST</a></li>
              <li><a href="#">SALE</a></li>
            </ul>
    ...
    <nav>
      <div class="div1">
        <div class="div1_1 div1_1_cart">
          <img src="../<?= $ROOT_URL ?>/asset/images/bannerroww1.png" alt="" />
          <div class="xemngay">
            <button><a href="#">xem ngay</a></button>
          </div>
        </div>
        ...
        <div class="div1_1 div1_1_cart">
          <img src="../<?= $ROOT_URL ?>/asset/images/bannerrow2.jpg" alt="" />
          <div class="xemngay">
            <button><a href="#">xem ngay</a></button>
          </div>
        </div>
        ...
        <div class="div1_1 div1_1_cart">
          <img src="../<?= $ROOT_URL ?>/asset/images/bannerroww2.webp" alt="" />
          <div class="xemngay">
            <button><a href="#">xem ngay</a></button>
          </div>
        </div>
      ...
      <div class="div1_2 div1_2_cart">
        <img src="../<?= $ROOT_URL ?>/asset/images/banneryoutube.jpg" alt="" />
        <div class="div_youtube">
          <!-- <video controls autoplay src="https://youtu.be/L7qbjrmQ728" width="520px" height="293px"></video> -->
          <iframe width="560" height="315" src="https://www.youtube.com/embed/L7qbjrmQ728" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
          ...
          <div class="product-row row-col-4">
            ...
            <div class="product-item">
              <a href="#" class="product-image-item">
                ...
                <img src="../<?= $ROOT_URL ?>/asset/images/ao-so-mi-nam-10s23shs004_ballad_blue_4__1.jpg" alt="" class="product-image-second" />
              </a>
              <div class="product-title">
                <a href="#" class="product-name">
                  Áo Sơ Mi Nam Tay Ngắn Linen Xếp Ly Trước Form Fitted
              ...
              <div class="product-color-list">
                <div class="product-color">
                  ...
                  <div class="product-color-hover">
                    <img src="../<?= $ROOT_URL ?>/asset/images/ao-so-mi-nam-10s23shs004_ballad_blue_1__1.jpg" alt="" class="product-color-img-hover" />
                    <span class="product-color-name"> BALAD BLUE </span>
                  </div>
                </div>
                ...
                <div class="product-color">
                  <div class="product-color-child">
                    <img src="../<?= $ROOT_URL ?>/asset/images/product1_con1.jpg" alt="" class="product-color-img" />
                  </div>
                  <div class="product-color-hover">
                    <img src="../<?= $ROOT_URL ?>/asset/images/product1_con1.jpg" alt="" class="product-color-img-hover" />
                    <span class="product-color-name"> BALAD BLUE </span>
                  </div>
                </div>
                ...
                <div class="product-color">
                  <div class="product-color-child">
                    <img src="../<?= $ROOT_URL ?>/asset/images/product1_con.jpg" alt="" class="product-color-img" />
                  </div>
                  <div class="product-color-hover">
                    <img src="../<?= $ROOT_URL ?>/asset/images/product1_con.jpg" alt="" class="product-color-img-hover" />
                    <span class="product-color-name"> BALAD BLUE </span>
                  </div>
                </div>
      ...
      <div class="div_bottomrowgird">
        <div class="div1_1 div1_1_cart">
          <img src="../<?= $ROOT_URL ?>/asset/images/banner_dm.png" alt="" />
          <div class="xemngay">
            <button><a href="#">xem ngay</a></button>
          </div>
        </div>
        ...
        <div class="div1_1 div1_1_cart">
          <img src="../<?= $ROOT_URL ?>/asset/images/banner_dm2.png" alt="" />
          <div class="xemngay">
            <button><a href="#">xem ngay</a></button>
          </div>
        </div>
      ...
      <div class="row_girdx">
        <div class="col column font_roboto">
          <div class="column_img">
            <img src="../<?= $ROOT_URL ?>/asset/images/tintuc1.jpg" style="width: 100%; height: 100%" alt="" />
          </div>
          <div class="column_info">
            <div class="column_button flexx font_roboto">
              <div class="button__1">
        ...
        <div class="col column font_roboto">
          <div class="column_img">
            <img src="../<?= $ROOT_URL ?>/asset/images/tintuc2.jpg" style="width: 100%; height: 100%" alt="" />
          </div>
          <div class="column_info">
            <div class="column_button flexx font_roboto">
              <div class="button__1">
        ...
        <div class="col column font_roboto">
          <div class="column_img">
            <img src="../<?= $ROOT_URL ?>/asset/images/tintuc3.jpg" style="width: 100%; height: 100%" alt="" />
          </div>
          <div class="column_info">
            <div class="column_button flexx font_roboto">
              <div class="button__1">
